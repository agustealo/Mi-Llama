...
def test_learning_signal_contract_is_explicit_and_append_only() -> None:
    ...
    assert "grant select, insert, update on public.learning_signals" not in sql
    assert "grant select, insert, update, delete on public.learning_signals" not in sql
    assert "create policy learning_signals_update" not in sql
    assert "create policy learning_signals_delete" not in sql
